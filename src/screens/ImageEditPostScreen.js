...
export default class ImageEditPostScreen extends Component {
  ...
  imagesCallback = (callback) => {
    ...
    callback.then(async (photos) => {
      ...
      navigation.navigate('EditPostScreen', {photos: cPhotos, count: count});
    })
  ...
  update =  (count, onSubmit) =>{
    this._renderDoneButton(count, onSubmit);
  }
